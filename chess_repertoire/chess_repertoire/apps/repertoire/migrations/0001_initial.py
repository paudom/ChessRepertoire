# Generated by Django 3.2.6 on 2022-06-15 15:46
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('difficulty', models.CharField(choices=[('B', 'BEGINNER'), ('I', 'INTERMEDIATE'), ('A', 'ADVANCED'), ('E', 'EXPERT')], max_length=30)),
                ('category', models.CharField(choices=[('CL', 'CLASSIC'), ('SY', 'SYSTEM'), ('GB', 'GAMBIT')], max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nature', models.CharField(choices=[('THC', 'THEORIC'), ('PST', 'POSITIONAL'), ('TRC', 'TRICKY'), ('SHP', 'SHARP'), ('ADV', 'ADVANTAGEOUS'), ('UNF', 'UNFAVORABLE')], max_length=30)),
